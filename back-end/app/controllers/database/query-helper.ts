 ...
 */
export class QueryHelper<TPersistedEntity extends PersistedEntityInternal> {
	private readonly databaseModel: Model<TPersistedEntity>;

	/**
	 * Constructor
	 * @param databaseModel the database model
	 */
	public constructor(databaseModel: Model<TPersistedEntity>) {
