...
Own-platform badges combine the two worlds: the icon is a CSS mask, and the stored platform color paints through it via `buildOwnPlatformMaskStyle(...)` ([§10.6](10-features.md#106-own-platforms)).
