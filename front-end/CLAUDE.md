...
- **Reuse the shared presentational building blocks before creating a screen-specific duplicate**: `generic/responsive-action-menu`, `generic/entity-management-screen`, `generic/entity-management-list`, `generic/entity-details-frame`, `generic/same-name-confirmation`, `generic/color-picker`, `generic/input`, `generic/select`, `generic/textarea`, `generic/field-error`, `generic/pagination`, `generic/responsive-header-button`, and the own-platform `icon-registry.ts` ([§11.3](docs/technical/11-interface.md#113-shared-building-blocks)).
