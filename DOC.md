...
- The shared formatting rules now live under `@stylistic/eslint-plugin` instead of deprecated ESLint core formatting rules, including a tab-based indentation rule, and a repo-wide lint fix pass normalized import ordering, semicolons, and spacing across the TS/TSX files.
